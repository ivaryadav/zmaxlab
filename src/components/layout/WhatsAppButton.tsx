...
const WA_NUMBER = '919451100556'
const WA_MESSAGE = 'Hi Ravi, I just got my NPI and need a website'
      ...
      <AnimatePresence>
        {tooltip && (
          ...
          >
            ...
            <span style={{ marginRight: 16 }}>👋 Need a healthcare website? Chat with Ravi now!</span>
