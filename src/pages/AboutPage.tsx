...
const VALUES = [
  { icon: <Heart size={20}/>, color: '#f472b6', title: 'Healthcare First', desc: 'Every decision — design, copy, features — is made through the lens of what helps practitioners get more patients.' },
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }}>
            <motion.div {...fadeUp()}>
              ...
              <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.65)', lineHeight: 1.8, marginBottom: 28 }}>
                ZmaxLab exists to fix that. One person, one mission: give every NPI-registered practitioner a website that actually works.
              </p>
              ...
              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 24, padding: 40 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {[
                    ...
                    { label: 'Response Time', value: 'WhatsApp within 2 hours' },
                  ].map(item => (
        ...
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <motion.div {...fadeUp()} style={{ marginBottom: 56 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              {[
                'A nurse practitioner I knew had just opened her own practice after 10 years working in a hospital. She was incredible at her job — patients loved her, referrals were strong. But online? She was invisible. Her only web presence was a 2-page PDF resume.',
          ...
          <motion.div {...fadeUp()} style={{ background: 'linear-gradient(135deg,rgba(27,111,255,0.08),rgba(0,200,150,0.06))', border: '1px solid rgba(27,111,255,0.2)', borderRadius: 24, padding: 'clamp(36px,5vw,52px)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 32 }}>
              {[
                ...
                'I will respond to every message within 2 hours during business hours',
