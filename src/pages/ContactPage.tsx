          ...
          <div style={{ background: '#07091f' }}>
                            ...
                            <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative' }}>
                                        <motion.div {...fadeUp()} style={{ maxWidth: 640 }}>
                                                      ...
                                                      <h1 style={{ ...GS, fontSize: 'clamp(2.2rem,5vw,4rem)', fontWeight: 800, color: '#fff', lineHeight: 1.1, letterSpacing: '-2px', marginBottom: 18 }}>
                                                                      Let's build your<br/>
                                                                      <span style={{ color: '#00c896' }}>healthcare website.</span>span>
                                                      </h1>h1>
                                                      ...
                                                      <motion.div {...fadeUp(0.15)} style={{ display: 'inline-flex', flexDirection: 'column', gap: 12 }}>
                                                                      <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 18, padding: '20px 24px', display: 'inline-flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
                                                                                        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                                                                                            ...
                                                                                                            <div>
                                                                                                                                <div style={{ ...GS, fontSize: 14, fontWeight: 700, color: '#fff' }}>Prefer to talk?</div>div>
                                                                                                                                <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)' }}>Book a free 30-minute discovery call</div>div>
                                                                                                              </div>div>
                                                                                          </div>div>
                                                                                      <a
                                                                    ...
                                                                    <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.35)', textAlign: 'center', display: 'block', marginTop: 4 }}>Or fill the form below ↓</span>span>
                ...
                <section style={{ padding: 'clamp(72px,9vw,112px) 5%', background: '#07091f' }}>
                        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 360px', gap: 52, alignItems: 'flex-start' }}>
                          ...
                          <div style={{ background: 'rgba(0,200,150,0.08)', border: '1px solid rgba(0,200,150,0.25)', borderRadius: 20, padding: 48, textAlign: 'center' }}>
                                          ...
                                          <h2 style={{ ...GS, fontSize: 24, fontWeight: 700, color: '#fff', marginBottom: 12 }}>Message sent!</h2>h2>
                          ...
                          <form onSubmit={handleSubmit} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: 'clamp(28px,4vw,40px)' }}>
                                          <h2 style={{ ...GS, fontSize: 22, fontWeight: 700, color: '#fff', marginBottom: 28 }}>Book Your Free Demo</h2>h2>
                            ...
                            {/* honeypot */}
                                          ...
                                          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
                                                            <div>
                                                                                <Label style={{ color: 'rgba(255,255,255,0.7)', fontSize: 13, fontWeight: 600, marginBottom: 6, display: 'block' }}>Full Name *</Label>Label>
                                                            ...
                                                            <div>
                                                                                <Label style={{ color: 'rgba(255,255,255,0.7)', fontSize: 13, fontWeight: 600, marginBottom: 6, display: 'block' }}>Email *</Label>Label>
                                          ...
                                          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
                                                            <div>
                                                                                <Label style={{ color: 'rgba(255,255,255,0.7)', fontSize: 13, fontWeight: 600, marginBottom: 6, display: 'block' }}>Phone / WhatsApp</Label>Label>
                                                            ...
                                                            <div>
                                                                                <Label style={{ color: 'rgba(255,255,255,0.7)', fontSize: 13, fontWeight: 600, marginBottom: 6, display: 'block' }}>Specialty *</Label>Label>
                                                                                <select required value={form.specialty} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setForm(f => ({ ...f, specialty: e.target.value }))} style={{ width: '100%', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', color: form.specialty ? '#fff' : 'rgba(255,255,255,0.4)', borderRadius: 10, height: 44, padding: '0 12px', fontSize: 14, outline: 'none' }}>
                                                                                                      <option value="" disabled style={{ background: '#07091f' }}>Select specialty…</option>option>
                                                                                  {SPECIALTIES.map(s => <option key={s} value={s} style={{ background: '#07091f', color: '#fff' }}>{s}</option>option>)}
                                                                                  </select>select>
                                                            </div>div>
                                          </div>div>
                          
                                          <div style={{ marginBottom: 16 }}>
                                                            <Label style={{ color: 'rgba(255,255,255,0.7)', fontSize: 13, fontWeight: 600, marginBottom: 6, display: 'block' }}>Practice / Clinic Name</Label>Label>
                                          ...
                                          <div style={{ marginBottom: 16 }}>
                                                            <Label style={{ color: 'rgba(255,255,255,0.7)', fontSize: 13, fontWeight: 600, marginBottom: 6, display: 'block' }}>What do you need most?</Label>Label>
                                                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                                                              {[['website','New Website'],['seo','Local SEO'],['booking','Online Booking'],['rebrand','Rebrand'],['other','Other']].map(([val,label]) => (
                                                  <button key={val} type="button" onClick={() => setForm(f => ({ ...f, service: val }))} style={{ padding: '7px 16px', borderRadius: 999, fontSize: 13, fontWeight: 600, cursor: 'pointer', border: `1px solid ${form.service === val ? '#1b6fff' : 'rgba(255,255,255,0.15)'}`, background: form.service === val ? 'rgba(27,111,255,0.2)' : 'rgba(255,255,255,0.04)', color: form.service === val ? '#7eb3ff' : 'rgba(255,255,255,0.55)', transition: 'all .2s' }}>{label}</button>button>
                                                ))}
                                                            </div>div>
                                          </div>div>
                          
                                          <div style={{ marginBottom: 24 }}>
                                                            <Label style={{ color: 'rgba(255,255,255,0.7)', fontSize: 13, fontWeight: 600, marginBottom: 6, display: 'block' }}>Anything else? (optional)</Label>Label>
                            ...
                            {error && <p style={{ color: '#f87171', fontSize: 13, marginBottom: 16 }}>{error}</p>p>}
                                          ...
                                          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.3)', textAlign: 'center', marginTop: 14 }}>No spam, no hard sell. Just your demo.</p>p>
                          </form>form>
                                              )}
                                  </motion.div>motion.div>
            ...
            { icon: <MessageSquare size={20}/>, title: '$500 flat · 7-day delivery', body: 'One price, no surprises. Your site is live in 7 days or your money back.' },
                                        ...
                                        <motion.div key={i} {...fadeUp(0.1 * i)} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: '20px 22px', display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                                                        <span style={{ color: '#1b6fff', marginTop: 2, flexShrink: 0 }}>{item.icon}</span>span>
                                                        <div>
                                                                          <div style={{ ...GS, fontSize: 14, fontWeight: 700, color: '#fff', marginBottom: 4 }}>{item.title}</div>div>
                                                                          <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)', lineHeight: 1.6 }}>{item.body}</div>div>
                                                        </div>div>
                                        </motion.div>motion.div>
                                      ))}
                                  </motion.div>motion.div>
