                      ...
                      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative' }}>
                                <motion.div {...fadeUp()}>
                                            ...
                                            <h1 style={{ ...GS, fontSize: 'clamp(2.2rem,5vw,4rem)', fontWeight: 800, color: '#fff', lineHeight: 1.1, letterSpacing: '-2px', marginBottom: 18 }}>
                                                          ...
                                                          <span style={{ color: '#00c896' }}>Add growth when ready.</span>span>
                                            </h1>h1>
              ...
              <section style={{ padding: 'clamp(72px,9vw,112px) 5%', background: '#03051a' }}>
                      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                                <motion.div {...fadeUp()} style={{ textAlign: 'center', marginBottom: 40 }}>
                                            <span style={{ fontSize: 11, fontWeight: 800, letterSpacing: '2px', textTransform: 'uppercase' as const, color: '#34d399', display: 'block', marginBottom: 10 }}>Core Service</span>span>
                                            <h2 style={{ ...GS, fontSize: 'clamp(1.8rem,3.5vw,2.6rem)', fontWeight: 700, color: '#fff', letterSpacing: '-1px' }}>Your website. Built right. The first time.</h2>h2>
                                </motion.div>motion.div>
                                <motion.div {...fadeUp(0.1)} style={{ background: 'linear-gradient(135deg,rgba(27,111,255,0.1),rgba(0,200,150,0.06))', border: '1px solid rgba(27,111,255,0.25)', borderRadius: 24, padding: 'clamp(28px,4vw,48px)', display: 'grid', gridTemplateColumns: '1fr 280px', gap: 48, alignItems: 'start' }}>
                                            <div>
                                                          <span style={{ ...GS, background: 'linear-gradient(135deg,#1b6fff,#00c896)', color: '#fff', fontSize: 10, fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase' as const, padding: '4px 14px', borderRadius: 999, display: 'inline-block', marginBottom: 20 }}>Website Package – $500 One-Time</span>span>
                                                          <h3 style={{ ...GS, fontSize: 24, fontWeight: 700, color: '#fff', marginBottom: 12, lineHeight: 1.3 }}>Custom healthcare website. No templates. Built personally by Ravi in 7 days.</h3>h3>
                                                          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, marginBottom: 28 }}>Every site coded from scratch for your specialty, location, and patient audience. Clean hand-coded HTML. Loads fast. Ranks well. Belongs to you forever.</p>p>
                            ...
                            <div key={f} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, padding: '12px 14px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 12 }}>
                                                ...
                                                <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)' }}>{f}</span>span>
                            </div>div>
                          ))}
                                                          </div>div>
                                            </div>div>
                                            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 20, padding: 28, textAlign: 'center', position: 'sticky', top: 96 }}>
                                                          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', marginBottom: 4 }}>Complete website</div>div>
                                                          <div style={{ ...GS, fontSize: 68, fontWeight: 900, color: '#fff', lineHeight: 1, letterSpacing: '-4px' }}>
                                                                          <sup style={{ fontSize: 26, verticalAlign: 'super', letterSpacing: 0 }}>$</sup>sup>500
                                                          </div>div>
                                                          <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', marginBottom: 22 }}>one-time · yours forever</div>div>
                            ...
                            <div key={l} style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12, marginBottom: 6 }}>
                                                <span style={{ color: 'rgba(255,255,255,0.5)' }}>{l}</span>span>
                                                <span style={{ color: c, fontWeight: l === 'ZmaxLab' ? 700 : 400 }}>{v}</span>span>
                            </div>div>
                          ))}
                                                          </div>div>
                                            </div>div>
                      ...
                      <style>{`@media(max-width:768px){.pkg-grid{grid-template-columns:1fr!important}}`}</style>style>
              </section>section>
              ...
              <section style={{ padding: 'clamp(72px,9vw,112px) 5%', background: '#07091f' }}>
                      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                                <motion.div {...fadeUp()} style={{ textAlign: 'center', marginBottom: 36 }}>
                                            <span style={{ fontSize: 11, fontWeight: 800, letterSpacing: '2px', textTransform: 'uppercase' as const, color: '#5b87ff', display: 'block', marginBottom: 10 }}>Growth Services</span>span>
                                            <h2 style={{ ...GS, fontSize: 'clamp(1.8rem,3.5vw,2.6rem)', fontWeight: 700, color: '#fff', letterSpacing: '-1px' }}>Optional add-ons. Add any time after launch.</h2>h2>
                                </motion.div>motion.div>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(260px,1fr))', gap: 20 }}>
                        {MONTHLY.map((s, i) => (
                                        <motion.div key={s.title} {...fadeUp(i * 0.07)} whileHover={{ y: -5 }}
                                                          ...
                                                          >
                                                          <h3 style={{ ...GS, fontSize: 17, fontWeight: 700, color: '#fff', marginBottom: 8 }}>{s.title}</h3>h3>
                                                          <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, marginBottom: 18 }}>{s.desc}</p>p>
                                                          ...
                                                          <div style={{ borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                                              <div>
                                                                                                    <span style={{ ...GS, fontSize: 28, fontWeight: 800, color: '#fff' }}>{s.price}</span>span>
                                                                                                    <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', marginLeft: 4 }}>/month</span>span>
                                                                              </div>div>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(260px,1fr))', gap: 18 }}>
                        {ONE_TIME.map((s, i) => (
                                        <motion.div key={s.title} {...fadeUp(i * 0.07)} whileHover={{ y: -4 }}
                                                          ...
                                                          >
                                                          <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase' as const, color: s.color, marginBottom: 10 }}>One-time {s.label}</div>div>
                                                          <h3 style={{ ...GS, fontSize: 16, fontWeight: 700, color: '#fff', marginBottom: 8 }}>{s.title}</h3>h3>
                                                          <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, marginBottom: 18 }}>{s.desc}</p>p>
                                                          <div style={{ borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: 14, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                                              <span style={{ ...GS, fontSize: 26, fontWeight: 800, color: '#fff' }}>{s.price}</span>span>
                                                                              <Link to="/contact" style={{ ...GS, background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.1)', color: '#fff', fontSize: 12, fontWeight: 700, padding: '7px 14px', borderRadius: 999 }}>Add</Link>Link>
                                                          </div>div>
                                        </motion.div>motion.div>
                                      ))}
                      </div>div>
                      ...
                      <motion.div {...fadeUp()} style={{ background: 'linear-gradient(135deg,rgba(0,200,150,0.08),rgba(59,111,240,0.08))', border: '2px solid rgba(0,200,150,0.2)', borderRadius: 24, padding: 'clamp(36px,5vw,56px)', textAlign: 'center' }}>
                                    <span style={{ ...GS, background: 'linear-gradient(135deg,#1b6fff,#00c896)', color: '#fff', fontSize: 10, fontWeight: 800, letterSpacing: '1.5px', textTransform: 'uppercase' as const, padding: '5px 16px', borderRadius: 999, display: 'inline-block', marginBottom: 24 }}>Best Value</span>span>
                                    <h3 style={{ ...GS, fontSize: 'clamp(1.6rem,3vw,2.4rem)', fontWeight: 700, color: '#fff', marginBottom: 14 }}>Complete Launch Bundle</h3>h3>
                                    <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.6)', maxWidth: 520, margin: '0 auto 36px', lineHeight: 1.75 }}>Everything to go from NPI number to fully online in one week.</p>p>
                                    <div style={{ display: 'flex', justifyContent: 'center', gap: 14, flexWrap: 'wrap', marginBottom: 36 }}>
                                      {[['$500','Website'],['$150','Google GBP'],['$75','NPI Dirs'],['$100','HIPAA Forms'],['$150','Blog Starter']].map(([price, label]) => (
                                          <div key={label} style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 10, padding: '12px 18px' }}>
                                                              <div style={{ ...GS, fontSize: 18, fontWeight: 800, color: '#34d399' }}>{price}</div>div>
                                                              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.5)', marginTop: 2 }}>{label}</div>div>
                                          </div>div>
                                        ))}
                                    </div>div>
                                    <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.4)', textDecoration: 'line-through', marginBottom: 6 }}>$975 purchased separately</div>div>
                                    <div style={{ ...GS, fontSize: 68, fontWeight: 900, color: '#34d399', letterSpacing: '-4px', lineHeight: 1 }}>
                                                    <sup style={{ fontSize: 28, verticalAlign: 'super', letterSpacing: 0 }}>$</sup>sup>799
                                    </div>div>
                                    <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', marginBottom: 28 }}>You save $176</div>div>
          ...
          {/* AUDIT CTA */}
              <section style={{ padding: '80px 5%', background: '#03051a', textAlign: 'center' }}>
                      <motion.div {...fadeUp()} style={{ maxWidth: 560, margin: '0 auto' }}>
                                <h2 style={{ ...GS, fontSize: 'clamp(1.6rem,3vw,2.2rem)', fontWeight: 700, color: '#fff', letterSpacing: '-1px', marginBottom: 14 }}>Not sure what you need?</h2>h2>
                                <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.6)', marginBottom: 28, lineHeight: 1.75 }}>Message me. I'll look at your current presence and tell you exactly what's missing — free.</p>p>
